<x-app-layout>
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
        <div class="">
            @if ($profile->isUser())
            <div class="flex p-4 bg-gray-100 sm:shadow-md sm:rounded-md justify-center">
            ...
            @endif
            <div class="p-2 bg-gray-100 sm:rounded-md sm:shadow-md mt-2 md:mt-3">
        ...
        <div class="bg-gray-100  sm:shadow-md sm:rounded-md">
