        ...
        <form wire:submit.prevent="create">
            ...
            <div>
                <div>
                    ...
                    <textarea autofocus x-ref="content" rows="3" wire:model.defer="content" placeholder="say something" class="w-full rounded-md form-textarea"></textarea>
                    ...
                    <div class="flex justify-end mt-3">
                        <div class="mr-4">
                            <x-jet-secondary-button @click="ready = false" wire:click="done" class="font-semibold text-red-700">
                                cancel
                        ...
                        <div>
                            <x-jet-button class="bg-blue-600">
                                <i wire:loading wire:target="create" class="font-black fas fa-spin fa-spinner"></i> &nbsp;{{ $type }}
                            </x-jet-button>
                        </div>
                    </div>
                </div>
