...
<div x-data="{ ready: false }"
    x-init="() => { Livewire.on('addedContent', () => { ready = false; }) }">
    <div x-show="!ready">
        {{ $trigger }}
    </div>
            ...
            <div>
                <div>
                    ...
                    <div class="flex items-baseline justify-between mb-2">
                        <x-jet-label class="mr-5 text-lg font-semibold"
                            value="{{ $type }}" />
                    ...
                    <div class="mt-3">
                        ...
                        <span @click=" $refs.photos.click() "
                            class="font-semibold text-blue-800 cursor-pointer">
                    ...
                    <div class="flex justify-end mt-3">
                        <div class="mr-4">
                            <x-jet-secondary-button @click="ready = false"
                                wire:click="done"
                        ...
                        <div>
                            <x-jet-button class="bg-blue-600">
                                <i wire:loading
                                    wire:target="create"
                                    class="font-black fas fa-spin fa-spinner"></i> &nbsp;{{ $type }}
                            </x-jet-button>
                        </div>
                    </div>
                </div>
