    ...
    <div class="@if(!$loop->last) mb-2 md:mb-4 @endif">
        <div class="flex">
            <div class="mr-2 sm:mr-4">
                <div style="background-image: url('{{ $comment->profile->profile_photo_url }}'); background-size: cover; background-position: center center;"
            ...
            <div>
                <div style="border-radius: 1rem;" class="flex-1 p-3 bg-gray-200">
                    ...
                    <x-display-text-content :content="$comment->content" />
                </div>
                <div class="flex mt-1">
                    <p>
