    ...
    <div class="@if(!$loop->last) mb-2 md:mb-4 @endif">
        <div class="flex">
            <div class="mr-2 sm:mr-4">
                <div style="background-image: url('{{ $comment->profile->profile_photo_url }}'); background-size: cover; background-position: center center;" class="w-12 h-12 mr-3 border-t-2 border-b-2 border-blue-700 rounded-full">
                </div>
            </div>
            <div>
