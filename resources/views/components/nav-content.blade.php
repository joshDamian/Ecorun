<div>
    ...
    <div class="font-light">
        ...
        <a href="{{ $currentProfile->url->bookmarks }}">
            <div
                class="px-4 py-3 font-medium tracking-wider text-blue-800 bg-gray-100 border-b-2 @if(request()->routeIs('bookmark.index')) border-blue-700 @else border-gray-200 @endif textext-left hover:border-blue-700 text-md md:cursor-pointer">
                <i class="text-blue-700 far fa-bookmark"></i> &nbsp;Bookmarks
            </div>
        </a>
