<div>
    ...
    <div>
        ...
        @else
        <div x-data x-init="() => { window.scrollTo(0, 0); }" class="@if($business->products->count() > 0) grid gap-2 sm:gap-2 grid-cols-2 sm:grid-cols-3 md:grid-cols-6 @endif px-2 sm:px-0">
