<div x-data
    ...
    <div class="fixed bottom-0 z-20 w-full bg-gray-200 md:sticky md:top-12">
        <ul class="flex overflow-x-auto">
            ...
            <li onclick=" window.UiHelpers.modifyUrl('{{ $key }}') " wire:click="switchView('{{ $key }}')" class="text-center @if($view === $active_view) text-blue-800 bg-white @else text-gray-800 @endif
                hover:bg-white md:flex-1 truncate flex-shrink-0 hover:text-blue-800 hover:border-transparent md:cursor-pointer
