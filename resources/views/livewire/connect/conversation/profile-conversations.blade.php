<div class="sm:grid sm:grid-cols-4">
    <div class="sm:col-span-3">
        ...
        @php $unread_count = $conversation->getUnreadFor($profile); @endphp
        @if($conversion instanceof \App\Models\DirectConversation)
        @php $patner = $conversation->pair->firstWhere('id', '!==', $profile->id); @endphp
        <div class="flex items-center p-3 bg-gray-100 shadow sm:p-0 sm:px-3 sm:py-3">
            <div style="background-image: url('{{ $patner->profile_photo_url }}'); background-size: cover; background-position: center center;"
            ...
            <div class="grid flex-1 flex-shrink-0 grid-cols-1">
                <div class="flex items-center justify-between">
                    <div class="flex-1 flex-shrink-0 font-semibold text-blue-700 truncate">
                        {{ ucfirst(strtolower($patner->name)) }}
                    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="flex-shrink-0 fa-stack fa-1x">
                        ...
                        <span
                            class="text-xs font-extrabold text-red-600 fa-stack-1x">{{ $unread_count  }}</span>
                    </span>
                    @endif
                </div>
            </div>
