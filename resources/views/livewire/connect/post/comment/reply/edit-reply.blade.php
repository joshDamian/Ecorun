<div>
    <div class="text-right mb-2">
        <x-jet-secondary-button wire:click="confirmDeleteReply">
    ...
    <div>
        ...
        <div class="bg-gray-100 font-semibold rounded-md border border-red-700 text-center text-red-700 px-3 py-2 mb-2">
            cannot empty reply content... consider deleting the reply.
        </div>
        @enderror
    </div>
    ...
    <x-connect.content.create-new-content :photos="$photos" :profilePhotoUrl="$profile->profile_photo_url" type="edit reply" />
    ...
    <div>
        <x-jet-confirmation-modal wire:model="confirm">
            ...
            <x-slot name="content">
                <div class="text-left">
                    Deleting a reply removes it entirely from our database. Consider editing it.
                </div>
            </x-slot>
            ...
            <x-slot name="footer">
                <div>
                    ...
                    <x-jet-danger-button wire:click="deleteReply">
                        {{ __('Delete') }}
                    </x-jet-danger-button>
                </div>
            </x-slot>
