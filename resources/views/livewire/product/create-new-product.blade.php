            ...
            <x-slot name="form">
                ...
                <div x-data class="relative col-span-6 sm:col-span-4 md:col-span-3">
                    ...
                    <div class="relative">
                        ...
                        <x-jet-input id="price" type="number"
                            class="relative mt-1 block w-full sm:py-2 sm:pr-2 sm:pl-12" placeholder="product price"
                ...
                <div class="col-span-6 sm:col-span-4 md:col-span-3">
                    ...
                    <x-jet-input id="available_stock" placeholder="available stock" type="number"
                        class="mt-1 block w-full" wire:model="available_stock" autocomplete="available_stock" />
