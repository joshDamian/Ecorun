<div>
    <div class="sm:hidden">
        <ul class="flex overflow-x-scroll scrolling-auto">
    ...
    <div x-data="{ fullmenu: false }" class="sm:grid hidden sm:block grid-cols-1 gap-4">
        @foreach ($actions as $key => $action)
        <div x-show.transition="! fullmenu">
        ...
        @endforeach
        <div x-on:click="fullmenu = ! fullmenu" class="cursor-pointer border-blue-700">
            <span class="fa-stack text-blue-800 fa-2x">
                <i class="fas fa-circle fa-stack-2x"></i>
                <i :title="fullmenu ? 'hide menu' : 'show menu'" style="font-size: 20px;"
