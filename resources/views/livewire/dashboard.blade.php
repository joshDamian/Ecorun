<div>
    <div class="flex bg-gray-900 flex-col md:flex-row">
        <div class="bg-gray-900 shadow-lg h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48">
            ...
            <div class="md:mt-12 bg-gray-900 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start
                text-left justify-between">
                <ul class="list-reset bg-gray-900 justify-center sm:overflow-x-hidden overflow-x-scroll flex flex-row
                    md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
        ...
        <div class="main-content flex-1 bg-gray-300 mt-12 md:mt-2 pb-16 md:pb-5">
