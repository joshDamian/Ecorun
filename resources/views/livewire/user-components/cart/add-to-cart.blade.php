<div>
    @if($this->existing())
    <div>
        @livewire('user-components.cart.cart-trigger', ['view' => 'button'], key('cart_trigger_3'))
    </div>
    @else
    <x-jet-button wire:click="request_data" class="bg-green-600 font-bold">
        {{ __('add to cart') }} &nbsp;<i class="fas fa-plus-circle"></i>
    </x-jet-button>
